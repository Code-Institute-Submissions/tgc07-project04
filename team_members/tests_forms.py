...
class TeamFormTestCase(TestCase):
    ...
    def test_team_member_required(self):
        ...
        self.assertEqual(form.errors['team_member'][0], 'This field is required.')
    ...
    def test_admin_user_required(self):
        ...
        self.assertEqual(form.errors['admin_user'][0], 'This field is required.')
    ...
    def test_project_manager_required(self):
        ...
        self.assertEqual(form.errors['project_manager'][0], 'This field is required.')
